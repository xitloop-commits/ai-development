...
function _TodayPnlBar({
  ...
  return (
    ...
    >
      ...
      {/* The bar */}
      <div className="relative w-full h-2.5 rounded-full bg-muted-foreground/30">
        ...
        {showExit && (
          <button
            type="button"
            onClick={onExitAll}
            className="absolute z-4 -translate-x-1/2 top-0 px-1 py-0 text-[0.5625rem] font-bold leading-none rounded bg-destructive/20 text-destructive border border-destructive/50 hover:bg-destructive/35 transition-colors whitespace-nowrap"
            style={{ left: "var(--m)" }}
