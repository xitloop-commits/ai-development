/**
 * TodayPnlBar v2.stories.tsx
 *
 * Rolling window marker system with configurable visible markers (default 15).
 */

import type { Meta, StoryObj } from "@storybook/react";
import { TodayPnlBar, DEFAULT_BAR_CONFIG, type BarConfig } from "./TodayPnlBar.v2";

const meta = {
  title: "Components/TodayPnlBar v2 (Rolling Window)",
