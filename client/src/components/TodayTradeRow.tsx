...
export interface TodayTradeRowProps {
   ...
   *  paper trade onto the LIVE book (real order, live config sizing). */
  onGoLive?: (tradeId: string) => void;
  /** This paper trade already has a live order placed → show "LIVE ✓". */
  goneLive?: boolean;
  /** The go-live order for this trade is in flight. */
