    ...
    <div className="sticky top-[49px] z-40 w-full border-b border-border bg-card/80 backdrop-blur-md">
      <div className="flex items-stretch divide-x divide-border">
        ...
        <div className="flex-none w-[160px] px-4 py-2 flex flex-col justify-center relative">
          <span className="text-[0.5rem] text-muted-foreground tracking-widest uppercase mb-0.5 self-start">
            Profit
          </span>
        ...
        <div className="flex-1 px-6 py-2 flex items-center justify-between gap-4">
          <div className="flex flex-col items-start">
            <span className="text-[0.5rem] text-muted-foreground tracking-widest uppercase mb-0.5">
              Capital
            </span>
        ...
        <div className="flex-none w-[200px] px-4 py-2 flex flex-col items-center justify-center bg-gradient-to-r from-transparent via-warning-amber/5 to-transparent">
          <span className="text-sm font-bold tabular-nums text-warning-amber">
            ...
            <span className={`text-[0.625rem] ${goldChange >= 0 ? 'text-bullish' : 'text-destructive'}`}>
        ...
        <div className="flex-none w-[160px] px-4 py-2 flex flex-col justify-center relative">
          <span className="text-[0.5rem] text-muted-foreground tracking-widest uppercase mb-0.5 self-end">
            Loss
          </span>
      ...
      {!capitalReady && (
        <div className="absolute top-0 right-2 text-[0.4375rem] text-warning-amber tracking-wider uppercase py-0.5">
