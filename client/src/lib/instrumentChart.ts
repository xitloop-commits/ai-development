...
export type IndicatorKey = "ma" | "reversals" | "sma" | "ema" | "sma9ema9" | "sma5" | "ema5" | "sma9" | "sma10" | "rsi" | "supertrend" | "maRibbon" | "sma5Ribbon" | "swings" | "dimSideways" | "entry" | "exit" | "tsl" | "oiWalls";

export const INDICATOR_OPTIONS: { key: IndicatorKey; label: string }[] = [
  { key: "oiWalls", label: "OI walls (call/put OI S/R, weight = size)" },
