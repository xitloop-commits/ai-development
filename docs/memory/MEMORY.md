...
- [Morning 2026-04-17 — verify tonight's fixes](project_morning_2026_04_17.md) — Single-use reminder: bring up Telegram .env copy + server startup watch when user says "good morning" on 2026-04-17. Delete after verification.
