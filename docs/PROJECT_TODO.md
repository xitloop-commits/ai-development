...
### T76 [UI] — Pop-out per-instrument underlying chart windows (Phase 1 BUILT 2026-07-12; needs browser verify) 🚧
Separate pop-out browser chart windows to watch/review the market from **our own tick data — NO Dhan**. Spec locked + **Phase 1 built 2026-07-12** (typechecks clean, 10 unit tests pass; not yet visually verified in a live browser).
