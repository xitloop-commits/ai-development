...
- **② γ — EOD square-off**: new market-close scheduler flattens every open trade at segment close (NSE 15:30 / MCX later) via `exitTrade` (reason EOD_SQUAREOFF), idempotent.
