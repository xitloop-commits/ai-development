...
- **Added label-backfill backstop** — `startup/backfill-labels.bat` (idempotent: runs the EOD replay only for instruments missing their labeled parquet; catches the silent-miss like 06-30 nifty50). Schedule ~23:55 daily or run manually.
