...
flowchart TD
    ...
    Promote{Pre-market check 08:50 IST<br/>Mon 2026-06-29<br/>7 green checks?}:::gate
...
|---|---|---|---|
| 4 — Accumulation | Mon 2026-05-19 | Recording + nightly replay only | 30 v8 sessions per instrument |
| First real retrain | Sat 2026-06-27 | LightGBM + calibration on 30 sessions | Sunday human review + Monday pre-market |
| 7a — Paper, min exits | Mon 2026-06-29 | TP/SL/trail/time/regime only | ≥50 signals/inst, WR ±5pp of backtest |
| 7b — Add OI exits | ~Mon 2026-07-14 | OI 5-min + 60-min triggers | A/B: ≥3pp WR or ≥15% DD lift |
| 7c — Add exhaustion | ~Mon 2026-07-28 | trend-tiring + premium-decel + volume-absorption | Same A/B gate vs 7b |
| 8 — AI-Live | ~Mid-Aug 2026 | Small live capital, then scaled | Paper vs live within ±5pp |
...
- **Holidays bump dates.** If 2026-05-22 turns out to be a holiday, day 30 lands a trading day later. `config/market_holidays.json` is the source of truth.
...
- Replace estimated dates with actuals as each milestone hits (e.g., "Sat 2026-06-27" becomes "Sat 2026-06-27 ✓ promoted to LATEST_HEADS").
